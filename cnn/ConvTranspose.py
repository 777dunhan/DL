...
class ConvTranspose1d():
    ...
    def forward(self, A):
        ...
        A0 = self.upsample1d.forward(A)  # TODO

        return self.conv1d_stride1.forward(A0)
    ...
    def backward(self, dLdZ):
        ...
        delta = self.conv1d_stride1.backward(dLdZ)  # TODO

        return self.upsample1d.backward(delta)
...
class ConvTranspose2d():
    ...
    def forward(self, A):
        ...
        """
        # upsample
        A0 = self.upsample2d.forward(A)  # TODO

        return self.conv2d_stride1.forward(A0)
    ...
    def backward(self, dLdZ):
        ...
        delta = self.conv2d_stride1.backward(dLdZ)  # TODO

        return self.upsample2d.backward(delta)
