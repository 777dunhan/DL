...
class RNNCell(object):
    ...
    def forward(self, x, h_prev_t):
        ...
        return self.activation.forward(x @ self.W_ih.T + self.b_ih + h_prev_t @ self.W_hh.T + self.b_hh) # TODO
    ...
    def backward(self, delta, h_t, h_prev_l, h_prev_t):
        ...
        # Done! Step backward through the tanh activation function.
        ...
        summed = np.sum(dz, axis=0) / batch_size
        self.db_ih += summed # TODO
        self.db_hh += summed # TODO

        return (dz @ self.W_ih), (dz @ self.W_hh) # TODO
